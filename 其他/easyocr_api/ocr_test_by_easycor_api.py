...
def recognize_image_by_easyocr_api(images_path):
    ...
    response = requests.post(ocr_api, headers=headers, data=data, timeout=5)
    print(response.text)
...
if __name__ == '__main__':
    ...
    recognize_image_by_easyocr_api(images_path)
